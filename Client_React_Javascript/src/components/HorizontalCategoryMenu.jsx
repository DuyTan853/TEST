// src/components/HorizontalCategoryMenu.jsx
import { Smartphone, Laptop, Tablet, Watch, Headphones, Cable } from 'lucide-react'

// Lấy lại mảng categories từ file CategoryMenu.jsx cũ của bạn
const categories = [
...
export default function HorizontalCategoryMenu() {
  return (
    <section className="bg-white rounded-lg shadow-md p-4 mb-6">
      {/* Trang mẫu không có tiêu đề này, nhưng bạn có thể thêm nếu muốn */}
